...
const Hero = () => {
    ...
    return (
        ...
        >
            ...
            <figure className=" relative flex-1 flex justify-center items-center xl:min-h-screen bg-primary bg-hero py-40 bg-cover bg-center max-sm:mb-40"><img src={bigShoeImg} alt="Show Collection" width={610} height={500} className=" object-contain relative z-10 mb-10 "></img>
